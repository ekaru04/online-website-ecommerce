    ...
    <header class="header mb-5">
      ...
      *** TOPBAR ***
      ...
      <div id="top">
        <div class="container">
          <div class="row">
          <!-- menampilkan navbar yang berisi nama web, tombol logout register dan contact-->
            <div class="col-lg-6 offer mb-3 mb-lg-0"><a  class="btn btn-success btn-sm">Clean In Click</a><a href="#" class="ml-1">Budayakan Malas Mencuci</a></div>
